    ...
    <div class="card-body">
        ...
        <div id="printable">
            <div>
                ...
                <h3 class="text-center m-0"><b>Báo cáo chi tiêu</b></h3>
                <hr style="width:15%">
                <p class="text-center m-0">Ngày giữa <b><?php echo date("M d, Y",strtotime($date_start)) ?> và <?php echo date("M d, Y",strtotime($date_end)) ?></b></p>
                <hr>
            </div>
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center" colspan="5">Không dữ liệu...</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
                <tfoot>
                    <tr>
                        <td class="text-right px-3" colspan="3"><b>Tổng</b></td>
